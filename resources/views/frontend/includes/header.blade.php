        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center content-center sm:items-stretch sm:justify-start ">
                <div class="flex-shrink-0 flex items-center">
                    <a href="/">
                        <img class="block lg:hidden h-10 w-auto" src="{{asset('img/logo-with-text.jpg')}}"
                            alt="{{ app_name() }}">
                    </a>
                    <a href="/">
                        <img class="hidden lg:block h-12 w-auto" src="{{asset('img/logo-with-text-dark.png')}}"
                            alt="{{ app_name() }}">
                    </a>
                </div>
                <div class="hidden sm:block sm:ml-6 justify-end">
                    <div class="flex space-x-6">
                        ...
                        <a href="{{ route('frontend.portfolio') }}"
                            class="text-gray-600 border-transparent border-b-2 hover:border-orange-600 px-3 py-2 text-base font-medium transition ease-out duration-300">
                            Portfolio
                        </a><a href="{{ route('frontend.contact') }}"
                            class="text-gray-600 border-transparent border-b-2 hover:border-orange-600 px-3 py-2 text-base font-medium transition ease-out duration-300">
                            Contact Us
                        </a>
                    </div>
